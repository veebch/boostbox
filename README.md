...
The Boostbox was originally a little project to turn an old Super 8 viewer into a YouTube viewing terminal. After some time tweaking it, it turned into a capable terminal that uses terminal mutiplexing (**tmux**), email (**neomutt**), encryption (**gpg**), chat (**weechat**) and scheduling (**gcalcli**).
