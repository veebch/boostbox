...
# Boostbox: The Terminal Applications
...
- Google calendar command line client [gcalcli](https://github.com/insanum/gcalcli) or the more flexible (not limited to Google) [khal](https://github.com/pimutils/khal)
